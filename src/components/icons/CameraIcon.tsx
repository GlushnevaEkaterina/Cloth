  ...
  return (
    <Svg
      ...
      <G>
        <Path
          fill={color || '#000000'}
          d="M1.5,32h35c0.827,0,1.5-0.673,1.5-1.5v-25C38,4.673,37.327,4,36.5,4h-35C0.673,4,0,4.673,0,5.5v25
        ...
        <Path
          fill={color || '#000000'}
          d="M19,25.988c4.963,0,9-4.038,9-9c0-4.962-4.037-9-9-9s-9,4.038-9,9C10,21.95,14.037,25.988,19,25.988z
		 M19,8.987c4.411,0,8,3.589,8,8c0,4.412-3.589,8-8,8s-8-3.589-8-8C11,12.576,14.589,8.987,19,8.987z"
        />
        <Path
          fill={color || '#000000'}
          d="M19,23.318c0.276,0,0.5-0.224,0.5-0.5s-0.224-0.5-0.5-0.5c-2.939,0-5.33-2.391-5.33-5.331
		c0-0.276-0.224-0.5-0.5-0.5s-0.5,0.224-0.5,0.5C12.67,20.478,15.51,23.318,19,23.318z"
        />
        <Path
          fill={color || '#000000'}
          d="M16.234,3.071c0.276,0,0.5-0.224,0.5-0.5C16.734,1.705,17.439,1,18.306,1h5.389
        ...
        <Path
          fill={color || '#000000'}
          d="M6.5,3C6.776,3,7,2.776,7,2.5C7,1.673,7.673,1,8.5,1S10,1.673,10,2.5C10,2.776,10.224,3,10.5,3
